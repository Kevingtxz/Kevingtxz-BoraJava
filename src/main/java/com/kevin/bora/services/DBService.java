...
public class DBService {
	...
	public void instantiateTestDatabase() {
		...
		chat1.getMainPages().addAll(Arrays.asList(mPE1, mPU1, mPU4, mPU5));
		chat2.getMainPages().addAll(Arrays.asList(mPU3, mPU2));
		chat3.getMainPages().addAll(Arrays.asList(mPU5, mPU3));
		chat4.getMainPages().addAll(Arrays.asList(mPU4, mPU6));
		chat5.getMainPages().addAll(Arrays.asList(mPE2, mPU2));		
		chat6.getMainPages().addAll(Arrays.asList(mPE4, mPU6));
		chat7.getMainPages().addAll(Arrays.asList(mPU3, mPU4));
		chat8.getMainPages().addAll(Arrays.asList(mPU6, mPE2));
		chat9.getMainPages().addAll(Arrays.asList(mPE3, mPU6, mPU2));
		chat10.getMainPages().addAll(Arrays.asList(mPU2, mPE2, mPU4));		
		...
		EventUsers eu1 = new EventUsers(null, mPE1);
		EventUsers eu3 = new EventUsers(null, mPE2);
		EventUsers eu4 = new EventUsers(null, mPE3);
		EventUsers eu5 = new EventUsers(null, mPE4);
		EventUsers eu6 = new EventUsers(null, mPE5);		
		EventUsers eu7 = new EventUsers(null, mPE6);
		...
		eventUsersRepository.saveAll(Arrays.asList(eu1,eu3, eu4, eu5, eu6, eu7));
